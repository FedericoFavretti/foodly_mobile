...
class _ChangePasswordScreenState extends State<ChangePasswordScreen> {
  ...
  Future<void> _handleStep3() async {
    ...
    try {
      ...
      Navigator.pop(context, AccountRepository.passwordChangeSuccessMessage);
    } on ApiException catch (error) {
      _showMessage(error.userMessage);
    } on NetworkException catch (error) {
      _showMessage(error.userMessage);
        ...
        children: [
          ...
          if (_step == 1) ...[
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Si iniciaste sesión con Google, tu cuenta no tiene una '
                      'contraseña propia para cambiar — usá el botón de '
                      'Google para entrar.',
            ...
            if (_isLoading)
              ...
              FoodlyButton(label: 'SOLICITAR CÓDIGO', onPressed: _handleStep1),
          ],
          ...
          if (_step == 2) ...[
            ...
            if (_isLoading)
              ...
              FoodlyButton(label: 'VERIFICAR CÓDIGO', onPressed: _handleStep2),
          ],
